...
CREATE TABLE yelp_business_attributes(
	...
	BYOB VARCHAR(255),
	Corkage VARCHAR(255),
	DietaryRestrictions_dairy_free VARCHAR(255),
	DietaryRestrictions_gluten_free VARCHAR(255),
	DietaryRestrictions_vegan VARCHAR(255),
	DietaryRestrictions_kosher VARCHAR(255),
	DietaryRestrictions_halal VARCHAR(255),
	DietaryRestrictions_soy_free VARCHAR(255),
...
CREATE TABLE airbnb_listing(
	...
	PRIMARY KEY(id),
	FOREIGN KEY(zipcode) REFERENCES ny_zipcode(zipcode)
);
